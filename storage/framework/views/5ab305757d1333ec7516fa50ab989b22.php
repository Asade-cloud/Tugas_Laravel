            ...
            <div class="offcanvas offcanvas-end bg-purple" id="offcanvasNavbar">
                ...
                <div class="offcanvas-body pt-0 px-4">
                    ...
                    <ul class="navbar-nav flex-row flex-wrap">
                        ...
                        <li class="nav-item col-6 col-md-auto"><a href="#" class="nav-link active">Examples</a>
                        </li>
                        <li class="nav-item col-6 col-md-auto"><a href="#" class="nav-link active">Icons</a></li>
                        <li class="nav-item col-6 col-md-auto"><a href="#" class="nav-link active">Themes</a></li>
                    ...
                    <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                        <li class="navbar-nav flex-row flex-wrap ms-md-auto">
                            <a href="#" class="nav-link active">
                                <i class="bi-github"></i><small class="ms-2d-md-none">Github</small>
                            </a>
                        </li>
                        <li class="nav-item col-6 col-md-auto">
                            <a href="#" class="nav-link active">
                                <i class="bi-twitter"></i><small class="ms-2d-md-none">Twitter</small>
                            </a>
                        </li>
                        <li class="nav-item col-6 col-md-auto">
                            <a href="#" class="nav-link active">
                                <i class="bi-twitter"></i><small class="ms-2d-md-none">Slack</small>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="dropdown" data-bs-theme="light">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    bg-purple"
                                            type="button"><small>latest (5.3.x) <i class="bi-check"></i></small>
                                        </button></li>
                                    <li><button class="dropdown-item" ype="button"><small>v5.2.3</small></button></li>
                        ...
                        <li class="nav-item col-12 col-lg-auto">
                            <div class="vr d-none d-lg-flex h-100 mx-1g-2 text-white"></div>
                            <hr class="d-lg-none my-2 text-white-50">
                            </li>
                        <li class="nav-item">
                            <!-- Dropdown -->
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-md-5 order-md-2">
                    <img class="img-fluid" src="<?php echo e(asset('images/main.svg')); ?>" alt="mainslogo">
                </div>
                <div class="col-md-7 order-md-1">
                    ...
                    <p class="fs-5 mt-3">Quickly design and customize responsive
                        ...
                        oolkit, featuring Sass variables and mixins, responsive grid system, extensive
                        prebuilt components, and powerful JavaScript plugins.</p>
                    <div class="row">
                        <div class="d-flex flex-column flex-md-row">
                            <button type="button" class="btn bg-purple text-white btn-1g mb-3 me-md-3 px-4 py-3">Get
                                Started</button>
                            <button type="button"
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p class="fs-5"><a href="#">Bootstrap Icons</a> is an open source
                        VG icon library featuring over 1,800 glyphs, with more added every release
                        They're designed to work in any project, whether you use Bootstrap itself or not.
                        Jse them as SVGs or icon fonts--both options give you vector scaling and easy
                        customization via CSS.</p>
                    <a class="icon-link icon-link-hover lead fw-semibold mb-5" href="#"> Get Bootstrap Icons <i
                            class="bi bi-arrow-right mb-2"></i>
                    </a>
                </div>
                <div class="col-lg-6">
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-lg-6">
                    <div class="mb-3 mt-5">
                        <i
                            class="bi bi-droplet-fill fs-2 bg-info py-2 px-3 rounded-3
                        text-white"></i>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-6 col-lg-2 offset-lg-1 mb-5">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"></li><a href="#">Swag Store</a></li>
                    </ul>
                </div>
                <div class="col-6 col-lg-2 mb-5">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><a href="#">Parcek</a></li>
                    </ul>
                </div>
                <div class="col-6 col-lg-2 mb-5">
                    <h5>Projects</h5>
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"></li><a href="#">npm starter</a></li>
                    </ul>
                </div>
                <div class="col-6 col-lg-2 mb-5">
                    <h5>Community</h5>
...
<?php /**PATH C:\xampp\htdocs\yogaa\resources\views/bootstrap.blade.php ENDPATH**/ ?>