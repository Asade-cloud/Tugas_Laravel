...
<body>
    <div class="container m-5">
        ...
        <div class="list-group list-group-numbered mt-4">
            ...
            <a href="<?php echo e(url('/title/thisismytittle')); ?>" class="list-group-item list-group-item-action">
...
<?php /**PATH C:\xampp\htdocs\yogaa\resources\views/routing.blade.php ENDPATH**/ ?>